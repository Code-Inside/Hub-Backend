...
namespace Hub
{
    ...
    {
        /// <summary>
        /// Cron: Each day at 5.30
        /// </summary>
        [FunctionName("Sloader")]
        public void Run([TimerTrigger("0 30 5 * * *")] TimerInfo myTimer, ILogger log)
        {
            ...
            var allConfigs = locator.FromGitHub("Code-Inside", "Hub", "_data", "*.Sloader.yml").GetAwaiter().GetResult();
